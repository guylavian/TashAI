...
--- TASK: Switch / Router Configuration Review ---
...
5. **Hardening recommendations** — SSH-only management, AAA, port security, storm control
6. **Compliance notes** — items that would fail a CIS or DISA STIG audit

Be specific — quote the exact config lines that are problematic."""
